...
#define WM_USER_ACTION              0x0401  /* Reserved for user messages ... (Keep the same as WIN32) */
#define WM_USER_ACTION_ADD_CARD     0x0402  /* Reserved for user messages ... (Keep the same as WIN32) */
#define WM_USER_ACTION_RELOAD       0x0403  /* Reserved for user messages ... (Keep the same as WIN32) */
#define WM_USER_CLOSE_WIN           0x0404  /* Reserved for user messages ... (Keep the same as WIN32) */       
#define WM_USER_ANSWER_MB           0x0405  /* Reserved for user messages ... (Keep the same as WIN32) */  
#define WM_USER_UNKNOW_ID           0x0406  /* Reserved for user messages ... (Keep the same as WIN32) */     
#define WM_USER_BLOCK_EN            0x0407  /* Reserved for user messages ... (Keep the same as WIN32) */  
#define WM_USER_BLOCK_ID            0x0408  /* Reserved for user messages ... (Keep the same as WIN32) */  
/*********************************************************************
*
*       Motion messages
*/
