...
uint16_t crc_16( uint8_t *ptr,uint8_t len )
{
   ...
   while( len-- )
   {
     index = (uint16_t)(CRC_Low ^ (*ptr++));
     CRC_Low = (uint8_t)(CRC_High ^ table_high[index]);
     CRC_High = table_low[index];
   }
...
/** end **/ 
  ...
  ****************************************************************************/
/******************************************************************************/
//устанавливаю нужный разряд в нужном байте 
/******************************************************************************/
...
/******************************************************************************/
uint8_t Compare_Arrays ( uint8_t* Ptr1, uint8_t* Ptr2, const uint32_t Lengh)   // 0 - различий нет   1 - есть
{
