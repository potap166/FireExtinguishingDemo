...
WM_HWIN CreateFramewinMenuDeviceTableofRespondDevCondAdr03E2_03E5KLAI (void );
 ...
 char *_aTable[1][3] ; 
  ...
  while(Qty_Row-->0)
  {
   ...
   ////////////////////////////////////
    //0
    _aTable[0][0]= "0";
    _aTable[0][1]=  "напряжение ЛС при U=24В" ;
    if ( CondPollingDev.Respond )
    {
       sprintf(GuiCharArray[0],"%u", ( Get_VolCurInLine24_KLAI ( Get_Adr_KL_Info ().KL - 1 )  & 0xFF )) ;
    ...
    //1
    _aTable[0][0]= "1";
    _aTable[0][1]=  "ток в ЛС при U=24В" ;
    if ( CondPollingDev.Respond )
    {
       sprintf(GuiCharArray[0],"%u", ( Get_VolCurInLine24_KLAI ( Get_Adr_KL_Info ().KL - 1 )  >> 8 )) ;
       _aTable[0][2]= (char*)&GuiCharArray[0];
    }
    else
    {
    ...
    //2
    _aTable[0][0]= "2";
    _aTable[0][1]=  "напряжение ЛС при U=13В" ;
    if ( CondPollingDev.Respond )
    {
       sprintf(GuiCharArray[0],"%u", ( Get_VolCurInLine13_KLAI ( Get_Adr_KL_Info ().KL - 1 )  & 0xFF )) ;
       _aTable[0][2]= (char*)&GuiCharArray[0];
    }
    else
    {
    ...
    //3
    _aTable[0][0]= "3";
    _aTable[0][1]=  "ток в ЛС при U=13В" ;
    if ( CondPollingDev.Respond )
    {
       sprintf(GuiCharArray[0],"%u", ( Get_VolCurInLine13_KLAI ( Get_Adr_KL_Info ().KL - 1 )  >> 8 )) ;
       _aTable[0][2]= (char*)&GuiCharArray[0];
    }
    else
    {
    ...
    //4
    _aTable[0][0]= "4";
    _aTable[0][1]=  "Количество запросов по ЛС" ;
    if ( CondPollingDev.Respond )
    { 
      sprintf(GuiCharArray[0],"%u",Get_QtyRequestLineMA_KLAI ( Get_Adr_KL_Info ().KL - 1  ) ) ;
       _aTable[0][2]= (char*)&GuiCharArray[0];      
    }
    else
    {
  ...
  ////////////////////////////////////
    //5
    _aTable[0][0]= "5";
    _aTable[0][1]=  "Количество запросов по ModBus" ;
    if ( CondPollingDev.Respond )
    {
       sprintf(GuiCharArray[0],"%u",Get_QtyRequestLineModbus_KLAI ( Get_Adr_KL_Info ().KL - 1 ) ) ;
       _aTable[0][2]= (char*)&GuiCharArray[0];
    }
    else
    {
