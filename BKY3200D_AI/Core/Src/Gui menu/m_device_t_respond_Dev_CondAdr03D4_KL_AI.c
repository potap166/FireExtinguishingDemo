...
WM_HWIN CreateFramewinMenuDeviceTableofRespondDevCondAdr03D4KLAI (void );
...
static void  Fill_Table ( const WM_HWIN hWin )   
{
 char *_aTable[1][3] ; 
  ...
  CondKLAIMbAdr03D4.all = Get_CondKL_Adr03D4_KLAI ( Get_Adr_KL_Info ().KL -1  ) ;  

   ////////////////////////////////////
    //0
    _aTable[0][0]= "0";
    _aTable[0][1]=  "ошибка при выдаче семафора" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.SemErrorType6 ) 
      {
        _aTable[0][2]=  "есть" ;
      }
      else
  ...
  ////////////////////////////////////
    //1
    _aTable[0][0]= "1";
    _aTable[0][1]=  "ошибка ОС тип 1 " ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.OSErrorType1 ) 
      {
        _aTable[0][2]=  "есть " ;
      }
      else
  ...
  ////////////////////////////////////
    //2
    _aTable[0][0]= "2";
    _aTable[0][1]=  "кз на левом входе" ;
    if ( CondPollingDev.Respond )
    { 
      if ( CondKLAIMbAdr03D4.KZLeftIn ) 
      {
        _aTable[0][2]=  "есть" ;
      }
      else
  ...
  ////////////////////////////////////
    //3
    _aTable[0][0]= "3";
    _aTable[0][1]=  "кз на правом входе" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.KZRighttIn ) 
      {
        _aTable[0][2]=  "есть" ;
      }
      else
  ...
  ////////////////////////////////////
    //4
    _aTable[0][0]= "4";
    _aTable[0][1]=  "кз линий связи" ;
    if ( CondPollingDev.Respond )
    { 
      if ( CondKLAIMbAdr03D4.KZline ) 
      {
        _aTable[0][2]=  "есть" ;
      }
      else
  ...
  ////////////////////////////////////
    //5
    _aTable[0][0]= "5";
    _aTable[0][1]=  "обрыв линий связи" ;
    if ( CondPollingDev.Respond )
    { 
      if ( CondKLAIMbAdr03D4.BreakLine ) 
      {
        _aTable[0][2]=  "есть" ;
      }
      else
   ...
   ////////////////////////////////////
    //6
    _aTable[0][0]= "6";
    _aTable[0][1]=  "переполнение буфера линий связи" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.OverFlowBufLine ) 
      {
        _aTable[0][2]=  "есть" ;
      }
      else
   ...
   ////////////////////////////////////
    //7
    _aTable[0][0]= "7";
    _aTable[0][1]=  "корпус кл вскрыт" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.OpenCap ) 
      {
        _aTable[0][2]=  "да" ;
      }
      else
   ...
   ////////////////////////////////////
    //8
    _aTable[0][0]= "8";
    _aTable[0][1]=  "переполние стека ОС" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.OSErrorType2 ) 
      {
        _aTable[0][2]=  "да" ;
      }
      else
...
////////////////////////////////////
    //9
    _aTable[0][0]= "9";
    _aTable[0][1]=  "ошибка ОС тип 3" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.OSErrorType3 ) 
      {
        _aTable[0][2]=  "да" ;
      }
      else
...
////////////////////////////////////
    //10
    _aTable[0][0]= "10";
    _aTable[0][1]=  "ошибка ОС тип 4" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.OSErrorType4 ) 
      {
        _aTable[0][2]=  "да" ;
      }
      else
...
////////////////////////////////////
    //11
    _aTable[0][0]= "11";
    _aTable[0][1]=  "ошибка ОС тип 5" ;
    if ( CondPollingDev.Respond )
    {
      if ( CondKLAIMbAdr03D4.OSErrorType5 ) 
      {
        _aTable[0][2]=  "да" ;
      }
      else
