...
extern  UART_HandleTypeDef * Get_Ptr_UART ( const uint8_t ) ;
extern TIM_HandleTypeDef  htim7,htim5;
...
{
  HAL_UART_IRQHandler ( Get_Ptr_UART ( 1 ) ) ; 
}
/** end **/
/******************************************************************************/
//USART2
...
{
  HAL_UART_IRQHandler ( Get_Ptr_UART ( 2 ) ) ; 
}
/** end **/
/******************************************************************************/
//
...
{ 
  ...
  //    uwPeriodValue1 = (uint16_t)(0xFFFF - tmpCC4[0] + tmpCC4[1] +1);
